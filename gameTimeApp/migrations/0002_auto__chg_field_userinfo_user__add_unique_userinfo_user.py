...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.user'
        db.alter_column(u'gameTimeApp_userinfo', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'UserInfo', fields ['user']
        db.create_unique(u'gameTimeApp_userinfo', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserInfo', fields ['user']
        db.delete_unique(u'gameTimeApp_userinfo', ['user_id'])


        # Changing field 'UserInfo.user'
        db.alter_column(u'gameTimeApp_userinfo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
